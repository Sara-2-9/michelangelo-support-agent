 ...
 *
 * Hamburger (always visible, opens the sidebar overlay) on the left, title
 * + subtitle centered, account action on the right: a surface/border "Sign
 * in" link to /auth for anonymous visitors, or the avatar UserMenu for
 * signed-in users.
 */
