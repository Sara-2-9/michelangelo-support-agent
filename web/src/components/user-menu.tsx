 ...
 *
 * The backdrop, panel and dialog render through a PORTAL on
 * document.body: they are position:fixed and this component lives inside
 * the header, which carries the entrance animation — any transform on an
 * ancestor would become their containing block and anchor them to the
 * header instead of the viewport (glitch seen right after sign-in, while
 * the animation replays). Portaled overlays are immune to any present or
 * future ancestor transform.
 */
...
export default function UserMenu() {
  ...
  return (
    <>
      ...
      {/* Everything below is position:fixed → portal to document.body so
          no animated/transformed ancestor can capture it. */}
      {createPortal(
        <>
